...
下面是OAuth2.0的流程：
![OAuth2.0](http://wangyuanqi.info/robot/1521379906296.png)
...
## Token Auth
![Token Auth](http://wangyuanqi.info/robot/1521379974597.png)
...
![Login progress](http://wangyuanqi.info/robot/1521422428757.jpg)
请求认证
基于Token的认证机制会在每一次请求中都带上完成签名的Token信息，这个Token信息可能在COOKIE
中，也可能在HTTP的Authorization头中；
![Login progress](http://wangyuanqi.info/robot/1521422527533.jpg)
