...
comment: true
tags: [前端,html,动画]
date: 2018-03-09 20:44:32
updated: 2018-03-09 20:44:32
---
...
除此之外，html5 还提供一个专门用于请求动画的API，那就是 requestAnimationFrame，顾名思义就是请求动画帧。 为了深入理解 requestAnimationFrame 背后的原理，我们首先需要了解一下与之相关的几个概念：
...
这个API的调用很简单，如下所示：<mark>递归调用</mark>
```bash
  var progress = 0;
  //回调函数
  function render() {
